...
<div class="row fs-5 mb-3">
        ...
        <div class="col-lg-7 col-12">
            <form action="{{route('staff.payment_confirm_store')}}" method="post" >
                @csrf
                <input type="hidden" name="payment_id" value="{{$payment->id}}">
                <input type="hidden" name="staff_id" value="{{Auth::guard('staff')->user()->id}}">
                <select name="payment_confirm" id="">
...
<div class="row fs-5 mb-3">
    <div class="col-lg-5 col-12">Payment Confirm</div>
    <div class="col-lg-7 col-12"><input type="text" disabled value="Confirmed by {{$payment_confirm->staff->name}}"></div>
</div>
<div class="row fs-5 mb-3">
    <div class="col-lg-5 col-12">Confirm Date</div>
    <div class="col-lg-7 col-12"><input type="date" disabled value="{{$payment_confirm->confirm_date}}"></div>
</div>
@else
<div class="row fs-5 mb-3">
    <div class="col-lg-5 col-12">Payment Confirm</div>
    <div class="col-lg-7 col-12"><input type="text" disabled value="Denied by {{$payment_confirm->staff->name}}"></div>
</div>
<div class="row fs-5 mb-3">
    <div class="col-lg-5 col-12">Confirm Date</div>
    <div class="col-lg-7 col-12"><input type="date" disabled value="{{$payment_confirm->confirm_date}}"></div>
