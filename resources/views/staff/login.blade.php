...
<div class="form-v6">
	<div class="page-content">
		<div class="form-v6-content">
			...
			<form class="form-detail d-flex flex-column m-auto" action="{{route('staff.login')}}" method="get">
			@csrf
			@if(Session::has('msg'))
                <h2 style="color:red;">{{ session::get('msg') }}</h2>
            @endif
				<h2 class="h2" style="font-family: 'Lobster', cursive;">Login To Staff Dashboard</h2>
				<div class="form-row">
