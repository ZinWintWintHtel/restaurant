...
<div class="bg-light m-5 text-lora">
        <h1 class="text-center text-warning py-3 ">Insert New Payment Method</h1>
        <div class="p-5">
        <form class="forms-sample" action="{{route('manager.paymentmethod_store')}}" method="post" enctype="multipart/form-data">
            @csrf

            <div class="form-group row mb-3">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Payment Method Logo</label>
                      <div class="col-sm-9">
                        <input type="file" class="form-control @error('title') is-invalid @enderror" name="method_image" id="exampleInputUsername2" >
                        @error('method_image')
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="method_name" id="exampleInputUsername2" placeholder="Enter Payment Method Name">
                        @error('method_name')
                        <div class="text text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="account_name" id="exampleInputEmail2" placeholder="Enter Account Name">
                        @error('account_name')
                        <div class="text text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control @error('account_number') is-invalid @enderror" name="account_number" id="exampleInputEmail2" placeholder="Enter Account Number">
                        @error('email')
                        <div class="text text-danger">{{ $message }}</div>
                        @enderror
                      </div>
