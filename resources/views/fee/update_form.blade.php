...
<div class="bg-light m-5 text-lora" style="height:72vh;">
        <h1 class="text-center text-warning py-3 ">Update Fees</h1>
        <div class="p-5">
        <form class="forms-sample" action="{{route('manager.fee_update')}}" method="post">
            @csrf
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control @error('amount') is-invalid @enderror" name="amount" required id="exampleInputUsername2" value="{{$fee->amount}}">
                        @error('amount')
                    ...
                    <div class="form-group row mb-5">
                      ...
                      <div class="col-sm-9">
                        <input type="date" class="form-control @error('date') is-invalid @enderror" name="date" required id="exampleInputEmail2" value="{{$fee->date}}">
                        @error('date')
                          <div class="text text-danger">{{ $message }}</div>
                        @enderror
                      </div>
