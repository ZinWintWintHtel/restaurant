                    ...
                    <div class="container-fluid text-lora ">
                      <div class="row bg-orange text-white py-1 px-5 ">
                          <div class="col-lg-6 col-12 mb-lg-0 mb-2 text-center">
                              <i class="bi bi-telephone-fill me-1"></i><span class="">09798546231</span>
                              <i class="bi bi-envelope-at-fill ms-3 me-1"></i><span>info@hothotbuffet.com</span>
                          </div>
                  ...
                  <nav class="navbar navbar-expand-lg bg-body-tertiary">
                      <div class="container-fluid">
                        <a class="navbar-brand ps-5 ms-5" href="{{url('/')}}">
                          ...
                          <span class="text-lobster fs-2">Hot Hot Buffet</span>
                        </a>
                ...
                <div class="reservation">
                  <form action="" class="reservationForm">
                    <div class="row">
                      ...
                      <div class="col-lg-4 col-6">
                        <input type="number" name="" id="" placeholder="Guest Num">
                      </div>
                      <div class="col-lg-12">
                        <button class="reserveNowBtn">Reserve Now</button>
                      </div>
                    </div>
                  </form>
                </div>
      ...
      <div class="footerBackgroundBox">
        <div class="container-fluid p-5 footerBox text-white">
          ...
          <div class="col-md-6 ps-5">
            <h2 class="text-lobster">HotHotBuffet</h2>
          ...
          <div class="col-md-6 ps-5">
            ...
            <p class="text-lora">Everyday : 8:00AM - 8:00PM</p>
