...
class ReservationController extends Controller
{
    ...
    public function showReservationForm(Request $request){
        ...
        $existing_tables = Reservation::select('table_id')
        ...
        $available_tables = DB::table('tables')->whereNotIn('id', $existing_tables)->where('max_capacity','>=',$request->guest_number)->get();
            
        return view('reservation.form')->with('data',$data)->with('fee',$fee)->with('tables',$available_tables)->with('payment_methods',$payment_methods);
